...
from denosing import denoise_audio
...
class SimpleAudioDataset(Dataset):
    def __init__(self, real_real_dir, real_fake_dir, fake_fake_dir, noise_dir, csv_file, transform=None, return_meta=False):
        ...
        self.load_folder_data(self.noise_dir, [0, 0])  # 새로운 노이즈 폴더
    ...
    def __getitem__(self, index):
        ...
        waveform = denoise_audio(waveform.numpy(), sample_rate)
...
if __name__ == '__main__':
    ...
    noise_dir = './output_noise/'  # 새로운 노이즈 폴더 경로
...
save_path = 'checkpoints(main+noise+denoise)'
